...
//   trackx = make(view, { w: 3, background: 0xffffff22, onMouseDown: () => this.dragTrack(this.trackx) })
//   tracky = make(view, { h: 3, background: 0xffffff22, onMouseDown: () => this.dragTrack(this.tracky) })

//   barx = make(view, { w: 3, background: 0x00000099, children: [this.trackx] })
//   bary = make(view, { h: 3, background: 0x00000099, children: [this.tracky] })
...
//     this.barx.onMouseEnter = () => this.scrollVisibleClaims++
//     this.bary.onMouseEnter = () => this.scrollVisibleClaims++
//     this.barx.onMouseExit = () => this.scrollVisibleClaims--
//     this.bary.onMouseExit = () => this.scrollVisibleClaims--
